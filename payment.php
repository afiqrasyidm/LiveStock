								...
								<div class="pay-tabs">
									<h2>Pilih Metode Pembayaran</h2>
									  <ul class="resp-tabs-list">
										  ...
										  <li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span><label class="pic3"></label>Transfer Bank</span></li>
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
										<div class="payment-info">
											...
											<div class="radio-btns">
												<div class="swit">								
													<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio" checked=""><i></i></label> 
													<img src="images/BNI.png" alt="Smiley face" height="35" width="200">
													</div>
													</div>
													<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio"><i></i></label> 
													<img src="images/BRI.png" alt="Smiley face" height="40" width="200">
													</div></div>
													<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio"><i></i></label> 
													<img src="images/BCA.png" alt="Smiley face" height="35" width="200">
													</div></div>
													<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio"><i></i></label> 
													<img src="images/mandiri_logo.png" alt="Smiley face" height="50" width="200">
													</div></div>	
												</div>
												<div class="clear"></div>
											</div>
